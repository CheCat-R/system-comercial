 ...
 * `oculto`: existe pero no se lista — mismo criterio que `enabled: false` en
 * un módulo entero, para un panel suelto (ver `VentasPage.jsx`).
 *
...
export const VENTAS_PANELS = [
  ...
  // Apagada junto con el módulo Web (mismo interruptor, `appConfig.features.
  // webHabilitado`): sin sitio, no hay pedidos que revisar acá.
  { id: 'ordenes', label: 'Órdenes web', icon: PublicIcon, permiso: 'ventas.ordenes', badge: 'ordenes', oculto: !appConfig.features.webHabilitado },
